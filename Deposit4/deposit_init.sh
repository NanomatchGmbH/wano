...
output=$(QPGetDepositDimensions --mode $mode --N {{ wano["TABS"]["Simulation Parameters"]["Dimensions"]["box"]["Number of Molecules"] }}  --X {{ wano["TABS"]["Simulation Parameters"]["Dimensions"]["box"]["X / A"] }}  --Y {{ wano["TABS"]["Simulation Parameters"]["Dimensions"]["box"]["Y / A"] }} --Z {{ wano["TABS"]["Simulation Parameters"]["Dimensions"]["box"]["Z / A"] }} {% if wano["TABS"]["Simulation Parameters"]["Dimensions"]["Morphology size defined by"]  == "number of molecules" %} --cubic {{ wano["TABS"]["Simulation Parameters"]["Dimensions"]["box"]["Cubic Box"] }} {% endif %} --pdb {% for element in wano["TABS"]["Molecules"]["Molecules"] %} {{ element["Molecule"] }} {% endfor %} --frac {% for element in wano["TABS"]["Molecules"]["Molecules"] %} {{ element["Mixing Ratio"] }}  {% endfor %})
